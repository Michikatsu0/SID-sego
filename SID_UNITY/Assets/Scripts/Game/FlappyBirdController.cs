...
public class FlappyBirdController : MonoBehaviour {
    ...
    void Flap()
    {
        transform.rotation = Quaternion.Lerp(Quaternion.Euler(transform.rotation.eulerAngles), forwardPosition, 10f);
    ...
    {
        if(!isPaused && !IsDead)
            transform.parent.Translate(new Vector3(0.01f/2, 0));
    }
